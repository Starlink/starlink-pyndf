...
m4_define([per_dir_PREFIX],   [m4_ifdef([OVERRIDE_PREFIX],
                                        [OVERRIDE_PREFIX],
                                        [/export/data/sgraves/sgraves-stardev])])
...
# /export/data/sgraves/sgraves-stardev.  Note that this directory may be
...
#
# However, we install software in /export/data/sgraves/sgraves-stardev by
