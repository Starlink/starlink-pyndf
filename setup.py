...
class custom_star_build(build_ext):
    ...
    def run(self):
        ...
        hdsex_includedirs = [
            'include', 'hds', 'missingincludes', 'hds_missingincludes',
            os.path.join('hdf5', 'src'),
            os.path.join('hdf5', 'hl', 'src'),
        ...
        ndfex_includedirs = hdsex_includedirs + \
            ['prm', 'ast', 'ary', 'ast_missingincludes', Ast.get_include()]
        ...
        for ext in self.extensions:
            ...
            if ext.name == 'starlink.hds':
                ...
                hds_deps = compiler.compile(sources=hds_source_dep,
                ...
                extra_preargs = None
                if osx:
                    extra_preargs = ['-v', '-Wl,-v',
                            install_name_pattern.format(hds_deps_libname)]

                compiler2.link('shared', hds_deps, hds_deps_libname,
                               output_dir=OUTPUTDIR,
                ...
                hdsv4objs = compiler.compile(sources=get_source('hds-v4'),
                                             output_dir=OUTPUTDIR,
                                             macros=define_macros,
                ...
                print('Linking HDSV4\n\n\n')
                compiler2.link('shared', hdsv4objs, hdsv4_libname,
                               output_dir=OUTPUTDIR,
                               extra_preargs=extra_preargs,
                               target_lang='c')
                ...
                hdsv5objs = compiler.compile(sources=get_source('hds-v5'),
                                             output_dir=OUTPUTDIR,
                                             macros=define_macros,
